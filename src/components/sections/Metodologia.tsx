        ...
        <div className="mobile-carousel md:grid md:grid-cols-4 md:gap-4 md:justify-items-center scrollbar-hide md:items-start relative z-20 overflow-x-auto min-h-[500px] md:min-h-[600px] pt-16">
          ...
          */}
          <div className="absolute inset-0 pointer-events-none z-10 overflow-visible min-w-max md:min-w-0">
            ...
            {/* Mobile SVG - Optimized for 280px fixed-width cards */}
            <div className="md:hidden flex h-full" style={{ width: '1240px' }}>
              <svg viewBox="0 0 1240 600" className="w-full h-full" preserveAspectRatio="none">
                <path
                  d="M 36,40 L 340,180 L 644,40 L 948,180"
                  fill="none"
                  stroke="var(--brand)"
                  strokeWidth="3"
                ...
                />
                <circle cx="36" cy="40" r="8" fill="var(--brand)" />
                <circle cx="340" cy="180" r="8" fill="var(--brand)" />
                <circle cx="644" cy="40" r="8" fill="var(--brand)" />
                <circle cx="948" cy="180" r="8" fill="var(--brand)" />
              </svg>
            </div>
          </div>
          ...
          {steps.map((step, idx) => {
            ...
            return (
              <div 
                key={idx} 
                className={`flex flex-col items-start text-left transition-all duration-700 min-w-[280px] md:min-w-0 px-6 md:px-0 relative z-20 ${
