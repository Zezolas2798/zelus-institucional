      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          <h2 className="text-3xl md:text-6xl font-medium text-white mb-8 leading-tight drop-shadow-2xl">
            Pronto para elevar o patamar do seu negócio?
          </h2>
          <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto font-normal leading-relaxed drop-shadow-lg">
            Fale diretamente com um especialista <span className="text-brand font-semibold underline decoration-brand/30 decoration-2 underline-offset-8">ZELUS</span>. Uma conversa estratégica para diagnosticar seus gargalos e desenhar o plano de ação para sua máxima rentabilidade.
          </p>
